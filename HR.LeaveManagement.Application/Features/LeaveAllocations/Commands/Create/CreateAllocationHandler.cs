...
{
    public class CreateAllocationHandler : IRequestHandler<CreateAllocationCommand, Unit>
    {
        private readonly IMapper _mapper;
        private readonly ILeaveAllocationRepository _leaveAllocationRepository;
        private readonly ILeaveTypeRepository _leaveTypeRepository;

        public CreateAllocationHandler(IMapper mapper,
        ...
        {
            var validator = new CreateAllocationValidator(_leaveTypeRepository);
